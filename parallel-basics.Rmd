Basics of Parallel Processing in R, Python, and Matlab
==============================================================
...
This tutorial covers basic strategies for using parallel processing in R, Python, and Matlab on single machine in which multiple processors (cores) share memory. 
...
This tutorial assumes you have a working knowledge of either R, Python, or Matlab. 
...
On BCE, both R and Python are linked against OpenBLAS as of BCE-fall-2015. (Note: for BCE-2015-spring, you need to run the add-on script *add-parallel-tools.sh* (see Section 0) to install OpenBLAS and link R against it; however  this will not link Python against OpenBLAS.)


## 2.2) Using threading 

### 2.2.1) Using threading in R
...
For other backends, such as *doParallel*, there is a package
called *doRNG* that ensures that *foreach* loops are reproducible.
