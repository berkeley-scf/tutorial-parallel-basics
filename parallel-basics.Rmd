...
On BCE, both R and (to some degree) Python are linked against OpenBLAS as of BCE-fall-2015. (Note: for BCE-2015-spring, you need to run the add-on script *add-parallel-tools.sh* (see Section 0) to install OpenBLAS and link R against it; however  this will not link Python against OpenBLAS.)
